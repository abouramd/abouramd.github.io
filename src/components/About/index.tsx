import profileImg from "../../assest/images/profileImg.jpeg";
import "./index.css";
import {
  BiLogoBootstrap,
  BiLogoCPlusPlus,
  ...
  return (
    <div className="about-section">
      ...
      <p>
        ...
        <a
          rel="noreferrer"
          href={"https://leetcode.com/abouramd"}
          target="_blank"
        >
          LeetCode
        </a>{" "}
      ...
      <p>
        Over the last two years i had Built multiple projects using various
        languages and technologe.
      </p>

      <p>
        If you'd like to collaborate, please send me an email or reach out{" "}
        <Link rel="noreferrer" to="/contact" style={{ fontWeight: "bold" }}>
          Here
        </Link>
        .
      </p>
      ...
      <div className="show-skills">
        <a
          href={"/assest/docs/abdelhay_bouramdane_resume.pdf"}
          rel="noreferrer"
          target={"_blank"}
